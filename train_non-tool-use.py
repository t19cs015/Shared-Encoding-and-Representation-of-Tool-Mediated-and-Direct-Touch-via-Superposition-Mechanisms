...
file_paths = [
    #"random/train1.pkl",
    "dataset/random81-2-VM/train9-VM.pkl",
    "dataset/random81-2-VM/train10-VM.pkl",
    "dataset/random81-2-VM/train11-VM.pkl",
    "dataset/random81-2-VM/train17-VM.pkl",
    "dataset/random81-2-VM/train13-VM.pkl",
    "dataset/random81-2-VM/train14-VM.pkl",
    "dataset/random81-2-VM/train15-VM.pkl",
    "dataset/random81-2-VM/train16-VM.pkl",
    #"data40/train9-40.pkl",
    #"data40/train10-40.pkl",
    #"data40/train11-40.pkl",
    #"data40/train12-40.pkl",
    #"data40/train13-40.pkl",
    #"data40/train14-40.pkl",
    #"data40/train15-40.pkl",
    #"data40/train16-40.pkl",
]

combined_train_dataset = MyDataset(file_paths)

with open("dataset/random81-2-VM/test2-VM.pkl", 'rb') as file:
